...
export const PROJECTS: Project[] = [
  {
    ...
    body:
      "Real-time agentic chat with structured message types, streaming responses, rich in-message animations and embedded map experiences. Built for a live production mobile app where the UX challenge is as hard as the engineering.",
  ...
  },
  {
    ...
    body:
      "Podcasts and video, blogs, community chat, events, and a full e-book / audiobook reader with in-app purchasing and progress tracking. Shipped to App Store and Play Store.",
  ...
  },
  {
    ...
    body:
      "Built with React. Role-based views, batch loading and client-side caching across large datasets, designed for daily use by ops administrators.",
  ...
  },
  {
    ...
    body:
      "Owned product architecture from a blank slate — design system, data layer, authentication, real-time portfolio views, and the entire investment-flow surface area.",
  ...
  },
  {
    ...
    body:
      "Record workflows via a Playwright-based Chrome extension, replay through an automated execution engine, manage test cycles and cases, and review screenshots and screen recordings of every run through the web dashboard.",
  ...
  },
  {
    ...
    body:
      "Covers the complete clinical and administrative workflow: patient registration and vitals, online and walk-in appointment booking with real-time status, role-gated views for admin / doctor / staff, and server-side PDF prescription generation.",
  ...
  },
  {
    ...
    blurb:
      "A marketing site for G-Datalabs — a small data engineering studio.",
    body:
      "Lightweight Next.js marketing surface with editorial typography, animated section transitions and a contact funnel.",
  ...
  },
  {
    ...
    year: "2023",
    blurb:
      "A focused alarm and reminders app — clean clock face, custom tones and snooze logic.",
    body:
      "Built in React Native with native modules for background scheduling, persistent notifications and audio playback respecting silent mode.",
